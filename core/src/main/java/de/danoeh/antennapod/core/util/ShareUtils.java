...
public class ShareUtils {
	...
	public static void shareLink(Context context, String text) {
		...
		PrefetchingLib.notifyExtras(Intent.createChooser(i, context.getString(R.string.share_url_label)).getExtras());
	...
	public static void shareFeedItemFile(Context context, FeedMedia media) {
		...
		PrefetchingLib.notifyExtras(Intent.createChooser(i, context.getString(R.string.share_file_label)).getExtras());

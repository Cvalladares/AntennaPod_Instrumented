...
public class MainPreferencesFragment extends PreferenceFragmentCompat {
    ...
    private void setupMainScreen() {
        ...
        findPreference(PREF_ABOUT).setOnPreferenceClickListener(
                preference -> {
                    PrefetchingLib.notifyExtras(new Intent(getActivity(), AboutActivity.class).getExtras());
        ...
        findPreference(STATISTICS).setOnPreferenceClickListener(
                preference -> {
                    PrefetchingLib.notifyExtras(new Intent(getActivity(), StatisticsActivity.class).getExtras());
...
//            PrefetchingLib.notifyExtras(Intent.createChooser.getExtras());
    ...
    private void openInBrowser(String url) {
        try {
            ...
            PrefetchingLib.notifyExtras(myIntent.getExtras());startActivity(myIntent);
